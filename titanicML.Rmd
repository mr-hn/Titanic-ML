...
#Accuracy of 78.469% since other features are taken into account as well
#This could indicate that these factors are negatively impacting the model
#But one should also keep in mind that the test dataset is small and hence this drop in accuracy need not indicate negative impact
...
#HN
#Study the tree to see which feature is throwing off the results
```
###Feature Engineering
```{R}
...
#The new features definitely helps in building a better model
...
#Again, this could be because of smaller dataset. This is probably the better model
#HN
#Study the model
```
